...
function zCall() {
    ...
    $.ajax({
        ...
        place_markers.push(marker);
            ...
            var rsts = $("<div id='restCard' class='wrapper col m4 s12 card small'><div id='picEdge' class='card-image waves-effect waves-block waves-light'><img id='resPic' class='activator' src='" + pic + "'></div><div class='card-content'><span class='card-title activator grey-text text-darken-4'>" + srch.name + "<i class='material-icons right'>more_vert</i></span><p><a target='_blank' href='" + srch.menu_url + "'>Click here for Menu</a></p></div><div class='card-reveal'><span class='card-title grey-text text-darken-4'>" + srch.name + "<i class='material-icons right'>close</i></span><h6>More Info:</h6><ul><h7>Street Address:</h7><li>" + srch.location.address + "</li><h7>Phone Number:</h7><li>" + srch.phone_numbers + "</li><h7>Customer Rating:</h7><li>" + srch.user_rating.aggregate_rating + "</li></ul><p><a target='_blank' href='" + srch.menu_url + "'>Click here for Menu</a></p></div></div>");
